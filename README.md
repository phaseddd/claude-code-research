...
本仓库会把它作为 `upstream/CometixSpace-claude-code` 引用，是因为我的研究
...
- `upstream/CometixSpace-claude-code/`: 指向 CometixSpace 项目的 Git submodule。
...
定时把 `upstream/CometixSpace-claude-code` 推进到上游 `origin/master` 的最新
