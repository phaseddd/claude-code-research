...
- [04-node-compat-patches.md](../BUN2JS/04-node-compat-patches.md) —— 同库机制页：CometixSpace 那条恢复流水线同样用 acorn 给抽出的 `cli.js` 打补丁（P1/P2/P3/P5/P7/P8/P10 按节点特征改写，P9 才走字符串替换），是本页「acorn 是 cli.js 改写链的概念基础」在**第三方项目**上的独立印证。
- [00-cometix-restore-pipeline.md](../BUN2JS/00-cometix-restore-pipeline.md) —— 那条流水线的整体顺序：补丁只是其中一环。
