...
| [mechanisms/claude-code-insights-slash-command.md](mechanisms/claude-code-insights-slash-command.md) | `/insights` 端到端 L0–L6：本页名词+双模型/双缓存→报告引擎漏斗→主会话分享句；2.1.209 | `topic:claude-code` · `topic:slash-command` · `topic:insights` · `form:mechanism` | active |
