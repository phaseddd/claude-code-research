...
| [mechanisms/claude-code-insights-slash-command.md](mechanisms/claude-code-insights-slash-command.md) | `/insights` 端到端：L0–L6 分发与报告引擎、双缓存漏斗、设计取舍；2.1.209 cli.js 静态 | `topic:claude-code` · `topic:slash-command` · `topic:insights` · `form:mechanism` | draft |
| [concepts/claude-code-insights-prompts.md](concepts/claude-code-insights-prompts.md) | `/insights` 内嵌提示词契约：各 P-id 英文原文、中文对照与链路位置（2.1.209 cli.js 静态提取） | `topic:claude-code` · `topic:slash-command` · `topic:insights` · `form:concept` | active |
