...
| [mechanisms/claude-code-insights-slash-command.md](mechanisms/claude-code-insights-slash-command.md) | `/insights` 端到端：本机缓存 + 模型侧分析、`Gm_` 投影漏斗、warmup/采样边界；2.1.209 cli.js 静态 | `topic:claude-code` · `topic:slash-command` · `topic:insights` · `form:mechanism` | active |
| [concepts/claude-code-insights-prompts.md](concepts/claude-code-insights-prompts.md) | `/insights` 内嵌提示词契约：P-id 原文/对照、Isp·DATA 拼装与 th_ 公共输入（2.1.209 cli.js） | `topic:claude-code` · `topic:slash-command` · `topic:insights` · `form:concept` | active |
