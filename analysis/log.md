...
[2026-09-08] maintenance | PriorKnowledge 按主题拆成 acorn/ 与 BUN2JS/；BUN2JS 六页按阅读顺序加 00–05 前缀（总览→交付→抽出→闸门→补丁→组包）；同步 index、组内互链、acorn 回链、advisor-tool / deepseek-compat-advisor-400 的 wiki 链，glossary 相对路径加深一层 | 无
