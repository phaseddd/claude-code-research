...
export const SESSIONS = [
  {
    ...
    tools: 9,
    tokens: 30000,
    meta: { durationMin: 48, toolCount: 9, language: '中文', messageCount: 46, tokenCount: 30000 },
  ...
  },
  {
    ...
    tools: 14,
    tokens: 22000,
    meta: { durationMin: 95, toolCount: 14, language: '中文', messageCount: 71, tokenCount: 22000 },
  ...
  },
  {
    ...
    tools: 8,
    tokens: 18000,
    meta: { durationMin: 72, toolCount: 8, language: '中文', messageCount: 58, tokenCount: 18000 },
  ...
  },
  {
    ...
    tools: 6,
    tokens: 14000,
    meta: { durationMin: 60, toolCount: 6, language: '中文', messageCount: 39, tokenCount: 14000 },
  ...
  },
  {
    ...
    tools: 18,
    tokens: 52000,
    meta: { durationMin: 180, toolCount: 18, language: '中文', messageCount: 96, tokenCount: 52000 },
  ...
  },
  {
    ...
    tools: 15,
    tokens: 44000,
    meta: { durationMin: 150, toolCount: 15, language: '中文', messageCount: 82, tokenCount: 44000 },
  ...
  },
  {
    ...
    tools: 7,
    tokens: 18000,
    meta: { durationMin: 55, toolCount: 7, language: '中文', messageCount: 34, tokenCount: 18000 },
  ...
  },
  {
    ...
    tools: 5,
    tokens: 26000,
    meta: { durationMin: 40, toolCount: 5, language: '中文', messageCount: 41, tokenCount: 26000 },
  ...
  },
  {
    ...
    tools: 4,
    tokens: 20000,
    meta: { durationMin: 35, toolCount: 4, language: '中文', messageCount: 28, tokenCount: 20000 },
  ...
  },
  {
    ...
    tools: 3,
    tokens: 8000,
    meta: { durationMin: 30, toolCount: 3, language: '中文', messageCount: 25, tokenCount: 8000 },
  ...
  },
  {
    ...
    tools: 5,
    tokens: 6000,
    meta: { durationMin: 26, toolCount: 5, language: '中文', messageCount: 22, tokenCount: 6000 },
  ...
  },
  {
    ...
    tools: 1,
    tokens: 2000,
    meta: { durationMin: 3, toolCount: 1, language: '中文', messageCount: 4, tokenCount: 2000 },
